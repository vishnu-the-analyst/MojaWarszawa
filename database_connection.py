...
def insert_message(data, category="NULL"):
    print(category)
    ...
    insert_query = """
    INSERT INTO messages (message_id, user_id, timestamp, text, picture, lon, lat, category)
    VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
    """

    # Data to be inserted
    record_to_insert = (message_id, user_id, timestamp, text, picture, lon, lat, category)
